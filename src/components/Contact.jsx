    ...
    <div className="contact-container">
      ...
      <div className="contact-content">
        ...
        <div className="contact-info">
          <h2>Grain & Mortar</h2>
          <p>1111 N. 13th St. Suite 141<br />Omaha, NE 68102</p>
          <p><a href="https://goo.gl/maps/xyz" target="_blank" rel="noopener noreferrer">Get Directions »</a></p>
          <p><strong>New business:</strong><br /><a href="mailto:hello@grainandmortar.com">hello@grainandmortar.com</a><br />402-370-8170</p>
          <iframe
            title="Google Maps"
