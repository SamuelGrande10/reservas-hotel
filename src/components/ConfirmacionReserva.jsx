...
const ConfirmacionReserva = () => {
  ...
  const handleProceedToPayment = () => {
    ...
    navigate("/pago", { state: { room_price, newReservationId } });
  };
    ...
    <>
      ...
      <div className="container mt-5 mb-5">
        ...
        <div className="card p-4 mt-4 text-center w-75 m-auto">
          ...
          <p>
            <strong>Habitación:</strong> {room.room_type}
          </p>
          <p>
          ...
          <p>
            <strong>Fecha de Llegada:</strong> {fechaLlegada}
          </p>
          <p>
            <strong>Fecha de Salida:</strong> {fechaSalida}
          </p>
          <p>
            <strong>Número de Huéspedes:</strong> {cantHuespedes}
          </p>
        </div>
